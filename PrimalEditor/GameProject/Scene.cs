...
namespace PrimalEditor.GameProject
{
    ...
    public class Scene : ViewModelBase
    {
        ...
        private void OnDeserialized(StreamingContext context)
        {
            ...
            if (_gameEntities != null) // has been initialized by: private observablecollection<scene> _scenes = new observablecollection<scene>();
            {
                GameEntities = new ReadOnlyObservableCollection<GameEntity>(_gameEntities);
                OnPropertyChanged(nameof(GameEntities)); // make controls update when binding to this list
            }
